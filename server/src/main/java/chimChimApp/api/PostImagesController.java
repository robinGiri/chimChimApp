...
import chimChimApp.services.PostImageService;
...
public class PostImagesController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<PostImageResponse> upload(@RequestParam("image") MultipartFile file, @RequestParam int postId)
            throws IOException {
