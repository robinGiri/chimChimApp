...
import chimChimApp.repositories.UserRepository;
import chimChimApp.requests.LoginRequest;
import chimChimApp.requests.RegisterRequest;
import chimChimApp.security.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<String> register(@RequestBody RegisterRequest registerRequest) {
        ...
        return new ResponseEntity<>(jwtUtil.generateToken(
                ...
                registerRequest.getName() + " " + registerRequest.getLastName()), HttpStatus.OK);
    }
